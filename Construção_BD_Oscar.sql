...
-- Etapa 3: Inserir dados nas tabelas

-- ## Tabela Ator
INSERT INTO Ator(ID_Ator, Nome_Ator, Cidade_Ator, Pais_Ator, Genero_Ator) VALUES
...
-- ## Tabela Diretor
INSERT INTO Diretor(ID_Diretor, Nome_Diretor, Cidade_Diretor, Pais_Diretor) VALUES
...
-- ## Tabela Filme
INSERT INTO Filme(ID_Filme, Titulo, ID_Diretor) VALUES
...
-- ## Tabela Premio
INSERT INTO Premio(ID_Premio, Descricao_Premio) VALUES
(1, 'Melhor Filme'),
(2, 'Melhor Diretor'),
(3, 'Melhor Ator'),
(4, 'Melhor Atriz');
...
-- ## Tabela Participacao
INSERT INTO Participacao(ID_Ator, ID_Filme) VALUES
(7, 18),
(11, 1),
(40, 4),
(9, 12),
...
-- ## Tabela Premiacao
INSERT INTO Premiacao(ID_Filme, ID_Premio, Ano) VALUES
(1, 1, 2011),
(1, 2, 2011),
(1, 3, 2011),
(2, 4, 2011),
...
-- Restrição de Integridade na tabela Ator
